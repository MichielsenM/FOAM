...
def theoretical_pattern_from_dfrow(summary_grid_row, Obs, Obs_pattern_parts, ObsErr_pattern_parts, which_observable, method_build_series,
    ...
    Obs_pattern_parts, ObsErr_pattern_parts: list of numpy array, dtype=float
...
def puls_series_from_given_puls(TheoIn, Obs, Obs_to_build_from, plot=False):
    ...
    Parameters
    ----------
    TheoIn: numpy array, dtype=float
...
def chisq_longest_sequence(tperiods,orders,operiods,operiods_errors):
    ...
    Parameters
    ----------
    tperiods : numpy array, dtype=float
        theoretical periods and their radial orders
    orders : numpy array, dtype=int
        radial orders corresponding to the periods in tperiods
    operiods, operiods_errors : numpy array, dtype=float

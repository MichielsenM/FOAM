...
class GridSummary:
    ...
    def create_summary_file(
        self,
        dir_path,
        columns=["star_age", "log_L", "log_R", "log_Teff", "log_g"],
        magnitudes=False,
        output_name="stellar_grid.h5",
        file_ending="hist",
    ...
    def _set_param_ranges(self):
        ...
        for parameter in self.grid_parameters:
            ...
            # Highest mass values have largest range in logDext, hence use highest key of each parameter
            dictionary = dictionary[dict_keys[-1]]
